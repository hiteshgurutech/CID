...
public class VerifySMS extends AppCompatActivity implements OtpReader.OTPListener {
...
//                                        if (CIDApp.getInstance().updateModel(phoneModel)) {
//                                            Toast.makeText(VerifySMS.this, "Device Updated Successfully", Toast.LENGTH_SHORT).show();
//                                        } else {
//                                            Toast.makeText(VerifySMS.this, "Failed to update", Toast.LENGTH_SHORT).show();
//                                        }
//
//                                        Toast.makeText(VerifySMS.this, "Device Updated Successfully", Toast.LENGTH_SHORT).show();
//                                    }

                                    //Toast.makeText(AddPhone.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
//                                    Intent intent = new Intent(activity, Home_old.class);
//                                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
//                                    startActivity(intent);
                                    PrefHelper.saveString(activity, Constants.KEY_PHONE_STATUS, (obj.getString("status")));
